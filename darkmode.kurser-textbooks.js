(function () {
    ...
    function getDeps() {
        try { return globalThis.DTUAfterDarkKurserTextbooksDeps || null; } catch (e0) { return null; }
    }
    ...
    function getTextbookLinkerFeatureKey() {
        var deps = getDeps();
        return deps && deps.featureKurserTextbookLinkerKey;
    }
    ...
    function insertKurserTextbookLinks() {
        ...
        if (!isFeatureFlagEnabled(getTextbookLinkerFeatureKey())) {
    ...
    try {
        globalThis.DTUAfterDarkKurserTextbooksUi = {
